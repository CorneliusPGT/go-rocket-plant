...
func (x *Manufacter) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Manufacter) ProtoMessage() {}

func (x *Manufacter) ProtoReflect() protoreflect.Message {
	mi := &file_proto_inventory_proto_msgTypes[1]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Manufacter.ProtoReflect.Descriptor instead.
func (*Manufacter) Descriptor() ([]byte, []int) {
	return file_proto_inventory_proto_rawDescGZIP(), []int{1}
}

func (x *Manufacter) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *Manufacter) GetCountry() string {
	if x != nil {
		return x.Country
	}
	return ""
...
func (x *Manufacter) GetWebsite() string {
	if x != nil {
		return x.Website
	}
	return ""
...
type Part struct {
	...
	Manufacter    *Manufacter            `protobuf:"bytes,8,opt,name=manufacter,proto3" json:"manufacter,omitempty"`
...
func (x *Part) GetManufacter() *Manufacter {
	if x != nil {
		return x.Manufacter
	}
	return nil
...
const file_proto_inventory_proto_rawDesc = "" +
	"\n" +
	"\x15proto/inventory.proto\x12\finventory.v1\x1a\x1fgoogle/protobuf/timestamp.proto\"j\n" +
	"\n" +
	"Dimensions\x12\x16\n" +
	...
	"\x06weight\x18\x04 \x01(\x01R\x06weight\"T\n" +
	"\n" +
	"Manufacter\x12\x12\n" +
	...
	"dimensions\x128\n" +
	"\n" +
	"manufacter\x18\b \x01(\v2\x18.inventory.v1.ManufacterR\n" +
	"manufacter\x12\x12\n" +
	...
	"\x05parts\x18\x01 \x03(\v2\x12.inventory.v1.PartR\x05parts*r\n" +
	"\bCategory\x12\x14\n" +
	...
	"\tListParts\x12\x1e.inventory.v1.ListPartsRequest\x1a\x1f.inventory.v1.ListPartsResponseB9Z7inventory-service/internal/grpc/inventorypb;inventorypbb\x06proto3"
...
var file_proto_inventory_proto_goTypes = []any{
	...
	(*Manufacter)(nil),            // 2: inventory.v1.Manufacter
...
var file_proto_inventory_proto_depIdxs = []int32{
	...
	2,  // 2: inventory.v1.Part.manufacter:type_name -> inventory.v1.Manufacter
...
func file_proto_inventory_proto_init() {
	...
	file_proto_inventory_proto_msgTypes[2].OneofWrappers = []any{
